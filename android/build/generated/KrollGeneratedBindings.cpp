...
#include "work.addiel.paint.PaintModule.h"
...
namespace titanium {
	namespace bindings {
		...
		BindEntry* PaintBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"work.addiel.paint.PaintModule", ::work::addiel::paint::PaintModule::bindProxy, ::work::addiel::paint::PaintModule::dispose},
				{"work.addiel.paint.PaintViewProxy", ::work::addiel::paint::paint::PaintViewProxy::bindProxy, ::work::addiel::paint::paint::PaintViewProxy::dispose}
			};
